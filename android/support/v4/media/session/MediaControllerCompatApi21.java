    ...
    public static class PlaybackInfo {
        ...
        private static int toLegacyStreamType(AudioAttributes aa) {
            ...
            switch (aa.getUsage()) {
                ...
                case C0148R.styleable.Toolbar_subtitleTextAppearance /*11*/:
                case C0148R.styleable.Toolbar_titleMargins /*12*/:
                case C0148R.styleable.Toolbar_titleMarginEnd /*14*/:
                    return 3;
                ...
                case STREAM_BLUETOOTH_SCO /*6*/:
                    return 2;
                case C0148R.styleable.Toolbar_titleMarginStart /*13*/:
                    return 1;
                default:
                    return 3;
            }
