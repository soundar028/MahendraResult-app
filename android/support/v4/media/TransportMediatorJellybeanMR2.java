...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    ...
    class C00291 implements OnWindowAttachListener {
        C00291() {
        }
    ...
    class C00302 implements OnWindowFocusChangeListener {
        C00302() {
        }
    ...
    class C00313 extends BroadcastReceiver {
        C00313() {
        }
    ...
    class C00324 implements OnAudioFocusChangeListener {
        C00324() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00291();
        this.mWindowFocusListener = new C00302();
        this.mMediaButtonReceiver = new C00313();
        this.mAudioFocusChangeListener = new C00324();
        this.mPlayState = 0;
