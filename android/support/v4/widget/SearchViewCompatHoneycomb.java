...
class SearchViewCompatHoneycomb {
    ...
    static class C00841 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00841(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00852 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00852(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
