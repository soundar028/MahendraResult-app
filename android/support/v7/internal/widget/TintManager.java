...
public final class TintManager {
    ...
    static {
        ...
        COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0111R.drawable.abc_textfield_search_default_mtrl_alpha, C0111R.drawable.abc_textfield_default_mtrl_alpha, C0111R.drawable.abc_ab_share_pack_mtrl_alpha};
        TINT_COLOR_CONTROL_NORMAL = new int[]{C0111R.drawable.abc_ic_ab_back_mtrl_am_alpha, C0111R.drawable.abc_ic_go_search_api_mtrl_alpha, C0111R.drawable.abc_ic_search_api_mtrl_alpha, C0111R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0111R.drawable.abc_ic_clear_mtrl_alpha, C0111R.drawable.abc_ic_menu_share_mtrl_alpha, C0111R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0111R.drawable.abc_ic_menu_cut_mtrl_alpha, C0111R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0111R.drawable.abc_ic_menu_paste_mtrl_am_alpha, C0111R.drawable.abc_ic_menu_moreoverflow_mtrl_alpha, C0111R.drawable.abc_ic_voice_search_api_mtrl_alpha};
        COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0111R.drawable.abc_textfield_activated_mtrl_alpha, C0111R.drawable.abc_textfield_search_activated_mtrl_alpha, C0111R.drawable.abc_cab_background_top_mtrl_alpha, C0111R.drawable.abc_text_cursor_material};
        COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0111R.drawable.abc_popup_background_mtrl_mult, C0111R.drawable.abc_cab_background_internal_bg, C0111R.drawable.abc_menu_hardkey_panel_mtrl_mult};
        TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0111R.drawable.abc_edit_text_material, C0111R.drawable.abc_tab_indicator_material, C0111R.drawable.abc_textfield_search_material, C0111R.drawable.abc_spinner_mtrl_am_alpha, C0111R.drawable.abc_spinner_textfield_background_material, C0111R.drawable.abc_ratingbar_full_material, C0111R.drawable.abc_switch_track_mtrl_alpha, C0111R.drawable.abc_switch_thumb_material, C0111R.drawable.abc_btn_default_mtrl_shape, C0111R.drawable.abc_btn_borderless_material};
        TINT_CHECKABLE_BUTTON_LIST = new int[]{C0111R.drawable.abc_btn_check_material, C0111R.drawable.abc_btn_radio_material};
    }
    ...
    public final ColorStateList getTintList(int resId) {
        ...
        if (context != null) {
            ...
            if (tint == null) {
                ...
                } else if (resId == C0111R.drawable.abc_btn_colored_material) {
    ...
    private ColorStateList createDefaultButtonColorStateList(Context context) {
        return createButtonColorStateList(context, C0111R.attr.colorButtonNormal);
    }

    private ColorStateList createColoredButtonColorStateList(Context context) {
        return createButtonColorStateList(context, C0111R.attr.colorAccent);
    }
