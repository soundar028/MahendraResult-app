...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    static class C01211 implements OnScrollChangedListener {
        ...
        C01211(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0111R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0111R.styleable.PopupWindow_overlapAnchor, COMPAT_OVERLAP_ANCHOR));
        }
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popup) {
        try {
            ...
            fieldListener.set(popup, new C01211(fieldAnchor, popup, (OnScrollChangedListener) fieldListener.get(popup)));
        } catch (Exception e) {
